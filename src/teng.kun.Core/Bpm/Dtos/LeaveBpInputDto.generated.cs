...
//      1.横向扩展：如需添加额外的属性，可新建文件“LeaveBpInputDto.cs”的分部类“public partial class LeaveBpInputDto”}添加属性
// </auto-generated>
//
//  <copyright file="LeaveBpInputDto.generated.cs" company="teng.kun">
//      teng.kun
//  </copyright>
...
namespace teng.kun.Bpm.Dtos
{
    ...
    /// 输入DTO：请假流程信息
    /// </summary>
    [MapTo(typeof(LeaveBp))]
    [Description("请假流程信息")]
    public partial class LeaveBpInputDto : IInputDto<int>
    {
        /// <summary>
        /// 获取或设置 编号
        /// </summary>
