    ...
    let columns: OsharpSTColumn[] = [
      {
        title: '操作', fixed: 'left', width: 65, buttons: [{
          text: '操作', children: [
            ...
            { text: '打印', icon: 'edit', acl: 'Root.Admin.OutStorManager.OutStor.Update', click: row => this.edit(row) },
            { text: '删除', icon: 'delete', type: 'del', acl: 'Root.Admin.OutStorManager.OutStor.Delete', click: row => this.delete(row) },
          ]
        }]
      },
      { title: '编号', index: 'Id', sort: true, readOnly: true, editable: true, filterable: true, ftype: 'number' },
      { title: '出库凭证号', index: 'OutstorVoucher', sort: true, editable: true, filterable: true, ftype: 'string' },
      { title: '所属公司', index: 'OutstorComName', sort: true, editable: true, filterable: true, ftype: 'string', enum: ['腾坤', 'B公司', 'C公司','D公司'] },
     ...
     // { title: '出库时间', index: 'OutstorDate', sort: true, editable: true, filterable: true, type: 'date' },
      ...
      { title: '派单人', index: 'OutEmpId', sort: true, editable: true, filterable: true, ftype: 'string', enum: ['A员工', 'B员工', 'C员工'] },
